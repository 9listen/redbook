...
// 加入我们组件数据
// 1.热招职位
export const reqGetHot = () => mockRequests.get('/getHotlist')
// 2.招聘动态
export const reqGetUpdate = () => mockRequests.get('/getUpdatelist')
// 3.公司相关、内容相关、协议条款
export const reqGetCon = () => mockRequests.get('/getConlist')